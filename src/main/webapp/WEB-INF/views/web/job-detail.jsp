...
.post-details1 {
	...
	<main> <!-- Navigation --> <%@ include
		file="/common/element/header.jsp"%> <!-- Hero Area Start-->
	...
	<!-- Hero Area End --> <!-- job post company Start -->
					...
					<div class="single-job-items mb-50">
						<div class="job-items">
							<div class="company-img company-img-details">
								<a href="#"><img src="/template/web/img/icon/job-list1.png"
									alt=""></a>
							</div>
							<div class="job-tittle">
								...
								<ul>
									...
									<li><span class="salary">${job.salary} -
											${job.salary+5} triệu</span></li>
				...
				<div class="right-content col-xl-4 col-lg-4">
					<div class="job-box post-details3  mb-50">
						...
						<ul>
							...
							<li>Mức lương: <span class="salary">${job.salary} -
									${job.salary+5} triệu</span></li>
						</ul>
						<div class="apply-btn2">
							<a href="/viec-lam/apply-form/${job.id}" class="btn">Ứng
								tuyển</a>
						</div>
					</div>
								...
								<c:if test="${job.employer_id==employer.id}">
									<c:forEach var="user" items="${users}">
										<c:if test="${employer.user_id==user.id}">
											<li>Tên : <span>${user.lastName}
													${user.firstName}</span></li>
	...
	<!-- job post company End --> <!-- Footer --> <%@ include
		file="/common/element/footer.jsp"%> </main>
</body>
</html>