...
<aside
	...
	<div class="sidenav-header">
		<i
			...
			src="/template/web/img/logo/logo2.png" class="navbar-brand-img h-150"
			alt="main_logo" style="width:160px;">
		</a>
	</div>
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><c:forEach items="${users}" var="user">
					<c:if test="${user.userName==SecurityUtils.getPrincipal().getUsername()}">
						<a class="nav-link" href="/nha-tuyen-dung/thong-tin-ca-nhan?id=${user.id}">
