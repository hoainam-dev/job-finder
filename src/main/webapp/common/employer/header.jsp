...
<aside
	...
	<div class="sidenav-header">
		<i
			...
			href="/nha-tuyen-dung/trang-chu"> <img
			src="/template/web/img/logo/logo.png" class="navbar-brand-img h-150"
			alt="main_logo">
		</a>
	</div>
	...
	<div class="collapse navbar-collapse  w-auto "
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link  "
                ...
                <g stroke="none" stroke-width="1" fill="none"
                  ...
                  <g transform="translate(-1869.000000, -293.000000)"
					...
					</div> <span class="nav-link-text ms-1">Danh sách việc làm</span>
			</a></li>
			<li class="nav-item"><a class="nav-link  "
				href="/nha-tuyen-dung/tao-viec-lam">
					<div
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <g stroke="none" stroke-width="1" fill="none"
                  ...
                  <g transform="translate(-2169.000000, -745.000000)"
					...
					</div> <span class="nav-link-text ms-1">Tạo việc làm</span>
			</a></li>
			<li class="nav-item"><a class="nav-link"
				href="/nha-tuyen-dung/danh-sach-ung-vien/${job.id}"> </a></li>
			<li class="nav-item"><c:forEach items="${users}" var="user">
					<c:if
						test="${user.userName==SecurityUtils.getPrincipal().getUsername()}">
						<a class="nav-link"
							href="/nha-tuyen-dung/thong-tin-ca-nhan?id=${user.id}">
							<div
								class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item"><a class="nav-link  " href="/thoat">
                ...
                <g stroke="none" stroke-width="1" fill="none"
                  ...
                  <g transform="translate(-2319.000000, -291.000000)"
					...
					</div> <span class="nav-link-text ms-1">Danh sách ứng viên</span>
			</a></li>
			...
			<g transform="translate(-1870.000000, -591.000000)" fill="#FFFFFF"
				fill-rule="nonzero"> <g
				transform="translate(1716.000000, 291.000000)"> <g
				transform="translate(154.000000, 300.000000)"> <path
	...
	<span class="nav-link-text ms-1">Thoát</span> </a>
	</li>
	</ul>
	</div>
</aside>