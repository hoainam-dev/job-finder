...
<aside
	...
	<div class="sidenav-header">
		<i
			...
			href="/quan-tri/trang-chu"> <img
			src="../template/web/img/logo/logo.png"
	...
	<div class="collapse navbar-collapse  w-auto "
		...
		<ul class="navbar-nav">
			<li class="nav-item"> <a class="nav-link active" href="<c:url value='/quan-tri/trang-chu' />">
					<div
			...
			<li class="nav-item"><a class="nav-link active" href="<c:url value='/quan-tri/nguoi-tim-viec' />">
					<div
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
